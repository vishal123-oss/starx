            ...
            <div className="hidden lg:flex flex-1 bg-primary p-12 items-center justify-center">
                <div className="max-w-md text-primary-foreground">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <span className="text-2xl font-bold">Xangoes</span>
                    </div>
                    <h2 className="text-3xl font-bold mb-4">
                        Start your journey today
                    </h2>
                    <p className="text-primary-foreground/80 mb-8">
                        Create an account and unlock access to hundreds of events. 
                        Register, pay, and get instant confirmations - all in one place.
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                        {[
                            ...
                            <div key={idx} className="bg-primary-foreground/10 rounded-lg p-4">
